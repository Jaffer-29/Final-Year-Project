//Faculty Code that display the Info of Other Staff Members
...
public class Faculty  extends JFrame {
    ...
    FacultyInfo[] fac = {
            ...
            new FacultyInfo("Shahid Khan", "Security Guard","Security Department", "8pm to 8am (Night Shift)","Monday to Sunday", "0302-6644511", "Emergency Gate"),
            new FacultyInfo("Shahab Abbas", "Admin Manager","Administration Department", "9am to 6pm","Monday to Saturday", "0321-5566778", "Admin Block"),
            new FacultyInfo("Sara Ali", "Receptionist","Administration Department", "8am to 4pm","Monday to Saturday", "0333-1122334", "Main Reception Desk"),
            new FacultyInfo("Imran", "Office Boy","Administration Department", "8am to 4pm","Monday to Saturday", "0301-2244668", "Admin Office"),
            new FacultyInfo("Ahmad Abdullah", "Office Boy","General Services", "9am to 5pm","Monday to Saturday", "0315-6677889", "ICU and OPD"),
    ...
    Faculty(){
        ...
        facBox.addActionListener(ae -> updateLabels(facBox.getSelectedIndex()));
        add(facBox);
...
class FacultyInfo{
    ...
    String name,role, department,shiftHours,workdays,contact,location;

    FacultyInfo(String name,String role,  String department, String shiftHours,
                String workdays, String contact,String location){
