//This class is for the Medicien Invantory
//The Code is a littel bit of complex but Good to go
...
public class Medicine extends JFrame {
    ...
    Medicine() throws IOException {
        ...
        disclaimer.setText("<html>"
                ...
                + "The Inventory also does not deal with sell and purchase of drugs.<br>"
